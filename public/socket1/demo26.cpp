/*
 * 程序名：demo26.cpp，此程序演示HTTP协议，接收http请求报文，然后回复一个网页。
 * author：invi
*/
#include "../_public.h"
...
int main(int argc,char *argv[])
{
  ...
  // 接收http客户端发送过来的报文。
  recv(TcpServer.m_connfd,buffer,1024,0);
...
/*
  ...
  // 再把html文件的内容发送给客户端。
  SendHtmlFile(TcpServer.m_connfd,"/tmp/index.html");

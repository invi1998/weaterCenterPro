...
{
  printf("\n");
  printf("Using:/project/tools/bin/fileclient7 logfilename xmlbuffer\n\n");

  printf("Sample:/project/tools/bin/procctl 20 /project/tools/bin/fileclient7 /tmp/fileclient7.log \"<ip>172.21.0.3</ip><port>5005</port><clientpath>/tmp/tcp/surfdata3</clientpath><srvpath>/tmp/tcp/surfdata4</srvpath><ptype>1</ptype><srvpathbak>/tmp/tcp/surfdata4bak</srvpathbak><andchild>true</andchild><matchname>*.XML,*.CSV</matchname><timetvl>10</timetvl><timeout>30</timeout><pname>fileclient7</pname>\"\n");

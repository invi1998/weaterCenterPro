...
{
  printf("\n");
  printf("Using:/project/tools/bin/fileclient2 logfilename xmlbuffer\n\n");

  printf("Sample:/project/tools/bin/fileclient2 /tmp/fileclient2.log \"<clienttype>1</clienttype><ip>172.21.0.3</ip><port>5005</port><ptype>1</ptype><clientpath>/tmp/tcp/surfdata1</clientpath><clientpathbak>/tmp/tcp/surfdata1bak</clientpathbak><andchild>true</andchild><matchname>*.XML,*.CSV</matchname><srvpath>/tmp/tcp/surfdata2</srvpath><timetvl>10</timetvl>\"\n\n\n");

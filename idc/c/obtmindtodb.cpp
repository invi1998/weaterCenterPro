...
int main(int argc, char* argv[])
{
    ...
    if (argc!=5)
    {
        ...
        printf("Example:/project/tools/bin/procctl 10 /project/idc/bin/obtmindtodb /idcdata/surfdata \"192.168.31.133,root,19981021115,mysql,3306\" utf8 /log/idc/obtmindtodb.log\n\n");
